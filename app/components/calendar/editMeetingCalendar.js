...
class EditMeetingCalendar extends Component {
    ...
    setReminder(response) {
        this.notif.updateScheduledNotification(response, globals.meetings, globals.type_calendar)
    }
...
<Text style={{ marginRight: 17, marginLeft: 17, fontSize:12, color:globals.colors.grey, marginTop:10}}>Duration*</Text>
                                ...
                                <Picker
                                    ...
                                    iosHeader="Status"
                                    placeholder="Status"
                                    style={{ width: deviceWidth, marginBottom:0 }}
                                        ...
                                        <Dropdown
                                            ...
                                            onFocus = {()=>{
                                                ...
                                                if(this.scrollViewRef!=null){
                                                    ...
                                                    console.log("this.scrollViewRef to end= ")
                                                }
                                            }}
                                            style={{ color: 'black', fontSize: 17, marginBottom: 0, paddingBottom: 0 }}
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(EditMeetingCalendar);