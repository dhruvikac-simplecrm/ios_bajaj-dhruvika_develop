...
//* this is a separate file to update meeting details for Account 

class UpdateMeetingAccount extends Component {
    ...
    constructor(props) {
        ...
        this.state.adata = this.props.data; //get the details form the detail view to the edit view
        this.state.parent_id = this.props.account_id; //need account details as well
    ...
    //re-format the date to send it to the CRM
    // reFormatDate(date){
    ...
    setReminder(response) {
        this.notif.updateScheduledNotification(response, globals.meetings, globals.accounts)
    }
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(UpdateMeetingAccount);