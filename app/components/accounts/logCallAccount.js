...
//* create a call for an account from here

class LogCallAccount extends Component {
    ...
    constructor(props) {
        ...
        this.state.account_data = this.props.data;// this is account data
        console.log(this.props.data);
        console.log('account id in log call: '+ this.state.account_data.id);
        console.log('assigned user id in log call: '+ this.state.account_data.assigned_user_id);
    ...
    onNavigatorEvent(event) { // this is the onPress handler for the two buttons together
        ...
        if (event.type == 'NavBarButtonPress') {
            ...
            if (event.id == 'create') { // this is the same id field from the static navigatorButtons definition
                ...
                this.logCall();//this method will create a call in the CRM inside specific account
            }
        }
    }
    ...
    logCall(){
        ...
        .then((response) => {
            ...
            if (response.success === true) {
                ...
                Navigation.startSingleScreenApp({//go to the calls detail view once the call is create view
                    screen: {
 ...
 /**
    ...
    setReminder(response) {
        this.notif.scheduleNotification(response, globals.calls, globals.accounts)
    }
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(LogCallAccount);