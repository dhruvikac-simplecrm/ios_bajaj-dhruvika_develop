...
//
class CreateTaskAccount extends Component {
    ...
    constructor(props) {
        ...
        console.log('lead id in schedule meeting: '+ this.state.account_data.id);
    ...
    createTask(){
        ...
        // "&reminder_c="+ this.state.reminder +
         ...
         "&assigned_user_name="+this.state.account_data.assigned_user_name +
    ...
    setReminder(response) {
        this.notif.scheduleNotification(response, globals.tasks, globals.accounts)
    }
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(CreateTaskAccount);