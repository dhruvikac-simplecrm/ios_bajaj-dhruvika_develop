...
let MeetingArray = new Array();
let TaskArray = new Array();
let LeadsArray = new Array();
let OpportunityArray = new Array();
...
class YTD extends Component {
    ...
    getCalls() {
        let url = globals.home_url + "/chart" + "?token_id=" + this.props.token +
            ...
            "&period=this_year" + "&field_name=status"
            + "&url=" + this.props.url;
    ...
    getOpportunities() {
        ...
        let url = globals.home_url + "/chart" + "?token_id=" + this.props.token +
            ...
            "&period=this_year" + "&field_name=sales_stage"
            + "&url=" + this.props.url;
        ...
        fetch(url, {
            ...
            .then((response) => {
                ...
                if (response.success === true) {
                    ...
                    console.log('Array of opportunities');
    ...
    render() {
        ...
        const opportunity_chart_wh = 200
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(YTD);