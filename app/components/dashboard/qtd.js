...
class Qtd extends Component {
    ...
    getCalls() {
        ...
        let url = globals.home_url + "/chart" + "?token_id=" + this.props.token +
            ...
            "&period=this_quarter" + "&field_name=status"
            + "&url=" + this.props.url;
    ...
    getOpportunities() {
        ...
        let url = globals.home_url + "/chart" + "?token_id=" + this.props.token +
            ...
            "&period=this_quarter" + "&field_name=sales_stage"
            + "&url=" + this.props.url;
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(Qtd);