...
class UpdateTaskLead extends Component {
            ...
            if (response.success === true) {
                ...
                Navigation.startSingleScreenApp({
                    screen: {
                        ...
                        passProps: {id: response.data.result.id,type: 'create',module: 'Tasks',lead_id: this.state.parent_id, parent_name: this.state.parent_name}, // simple serializable object that will pass as props to all top screens (optional)
                    animationType: 'slide-horizontal'
                })
                ...
                apiCallForToken.getToken(this.props).then(token => {
                    ...
                    //update the task, after session generated
                    this.updateTask()
    ...
    setReminder(response) {
        this.notif.updateScheduledNotification(response, globals.tasks, globals.leads)
    }
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(UpdateTaskLead);