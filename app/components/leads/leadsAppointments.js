...
import { Container, Content, ListItem, Body, Card, Text } from 'native-base';
...
class LeadsAppointments extends Component {
    ...
    getAppointments(){
        ...
        "&module_id=" + this.state.lead_data.id + "&status_array=" +globals.APPOINTMENT_STATUS
        + "&url="+this.props.url;
        ...
        .then((response) => {
            ...
            if (response.success === true) {
                ...
                apiCallForToken.getToken(this.props).then(token => {
                    ...
                    //Get Appointments, after session generated
                    this.getAppointments()
...
{
//     item.date_entered != '' ?
// (<View ><Text style={{ fontSize: 14, color: globals.colors.grey, fontStyle: 'italic' }} >{
//     globals.formatUtcDateAndTimeToLocal(item.date_entered)
// }</Text></View>
// ) :
// (
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(LeadsAppointments);