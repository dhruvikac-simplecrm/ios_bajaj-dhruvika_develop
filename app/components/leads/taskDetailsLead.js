...
class TaskDetailsLeads extends Component {
        ...
        if (event.type == 'NavBarButtonPress') {
            ...
            if (event.id == 'edit') { // this is the same id field from the static navigatorButtons definition
                ...
                this.props.navigator.push({
                    screen: 'app.UpdateTaskLead',
                    title: 'Edit Task',
                    subtitle: undefined, // navigation bar subtitle of the pushed screen (optional)
                    passProps: { data: this.state.task_data, lead_id: this.props.lead_id, parent_name: parent_name}, // Object that will be passed as props to the pushed screen (optional)
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(TaskDetailsLeads);