...
import { Container, Content,Button, Label, Item, Text } from 'native-base';
...
class MeetingDetailsLeads extends Component {
        ...
        if (event.type == 'NavBarButtonPress') {
            ...
            if (event.id == 'edit') { // this is the same id field from the static navigatorButtons definition
                ...
                this.props.navigator.push({
                    screen: 'app.UpdateMeetingLead',
                    title: 'Edit Meeting',
                    subtitle: undefined, // navigation bar subtitle of the pushed screen (optional)
                    passProps: { data: this.state.meeting_data, lead_id: this.props.lead_id , parent_name: parent_name}, // Object that will be passed as props to the pushed screen (optional)
    ...
    goBack(){
        Navigation.startSingleScreenApp({
            ...
            passProps: { lead_id: this.props.lead_id }, // Object that will be passed as props to the pushed screen (optional)
        });
    }
                ...
                if (response.success === true) {
                    ...
                    if(this.props.from_list){
                        this.props.navigator.push({
                            ...
                            title: 'Edit Meeting',
                            subtitle: undefined, // navigation bar subtitle of the pushed screen (optional)
                            passProps: { data: this.state.meeting_data, lead_id: this.props.lead_id }, // Object that will be passed as props to the pushed screen (optional)
                            animated: true, // does the push have transition animation or does it happen immediately (optional)
                            animationType: 'slide-horizontal', // 'fade' (for both) / 'slide-horizontal' (for android) does the push have different transition animation (optional)
                            backButtonTitle: 'Back', // override the back button title (optional)
                            backButtonHidden: false, // hide the back button altogether (optional)
                    ...
                    apiCallForToken.getToken(this.props).then(token => {
                        ...
                        //get the task details, after session generated
                        this.getDetails()
            ...
            <Container style={{ backgroundColor: '#fafafa' }} >
                <Content>
                    ...
                    <View style={{ padding: 5 }}>
                        ...
                        <Label style={{ fontSize: 12.5, color: 'grey', padding: 10, backgroundColor: '#fafafa' }}>Related to Lead</Label>
                        <Button transparent onPress={() => this.leadDetails(this.props.lead_id)} >
...
export default Login = connect(mapStateToProps, mapDispatchToProps)(MeetingDetailsLeads);